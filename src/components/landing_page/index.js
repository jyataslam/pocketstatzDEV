        ...
        <div className="landing-container">
            ...
            <section className="landing-buttons">
                <div className="row signup-buttons">
                    <Link to="/account/sign-in" id="landing-btn" className="center btn col s4 offset-s1 hide-on-med-and-up">Log In</Link>
                    <Link to="/account/sign-up" id="landing-btn" className="center btn col s4 offset-s2 hide-on-med-and-up">Sign Up</Link>

                    <Link to="/account/sign-in" id="landing-btn" className="center btn col m3 offset-m2 hide-on-small-only">Log In</Link>
                    <Link to="/account/sign-up" id="landing-btn" className="center btn col m3 offset-m2 hide-on-small-only">Sign Up</Link>
                </div>
