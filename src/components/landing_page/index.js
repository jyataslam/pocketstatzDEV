        ...
        <div className="landing-container">
            ...
            <section className="landing-buttons">
                <div className="row signup-buttons">
                    ...
                    <Link to="/account/sign-in" id="landing-btn" className="center btn btn-large col m3 offset-m2 hide-on-small-only orange darken-3">Sign In</Link>
                    <Link to="/account/sign-up" id="landing-btn" className="center btn btn-large col m3 offset-m2 hide-on-small-only orange darken-3">Sign Up</Link>
                </div>
